...
train_loader = torch.utils.data.DataLoader(train_dataset_cub, batch_size=16, shuffle=True, num_workers=4, pin_memory=True) #24
test_loader = torch.utils.data.DataLoader(test_dataset_cub, batch_size=16, shuffle=False, num_workers=4, pin_memory=True) #24

lr = 1e-5 #CHANGE
# Define loss function and optimizer
criterion = nn.CrossEntropyLoss()
path = os.path.join('/home/thao.nguyen/CV703/Assignment_01/New/Modified/', f"ConvNextV2L_t1_Att12_Drop_256.pth") #CHANGE
...
if not os.path.exists(log_dir):
    os.makedirs(log_dir)
log_filename = datetime.now().strftime('%Y-%m-%d_%H-%M-%S') + '_Att12_Drop_256_task1.log'
...
# checkpoint = torch.load('/home/thao.nguyen/CV703/Assignment_01/L5009/ConvNextV2L_t1_Att_Drop_256.pth') #CHANGE
