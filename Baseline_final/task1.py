...
path = os.path.join('/home/thao.nguyen/CV703/Assignment_01/New/Baseline/', f"ConvNextV2L_t1_256.pth") #CHANGE
...
log_dir = '/home/thao.nguyen/CV703/Assignment_01/New/Baseline/'  # Change to your desired log directory
if not os.path.exists(log_dir):
    os.makedirs(log_dir)
log_filename = datetime.now().strftime('%Y-%m-%d_%H-%M-%S') + '_256_task1.log'
