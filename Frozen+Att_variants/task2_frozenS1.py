...
path = os.path.join('/home/thao.nguyen/CV703/Assignment_01/Graph+code/Modified/', f"task2_fronzenS1.pth") #CHANGE
...
if not os.path.exists(log_dir):
    os.makedirs(log_dir)
log_filename = datetime.now().strftime('%Y-%m-%d_%H-%M-%S') + 'task2_fronzenS1.log'
