...
path = os.path.join('/home/thao.nguyen/CV703/Assignment_01/L5004/', f"ConvNextV2L_t2_Att_Dropout_256.pth") #CHANGE
...
log_dir = '/home/thao.nguyen/CV703/Assignment_01/L5004/'  # Change to your desired log directory
if not os.path.exists(log_dir):
    os.makedirs(log_dir)
log_filename = datetime.now().strftime('%Y-%m-%d_%H-%M-%S') + '_Att_Dropout_256_task2.log'
