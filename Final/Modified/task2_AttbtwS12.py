...
path = os.path.join('/home/sarim.hashmi/Downloads/CV703/CV703_Final/Final/Modified/', f"task2_with_dropout_only.pth") #CHANGE
...
log_dir = '/home/sarim.hashmi/Downloads/CV703/CV703_Final/Final/Modified/'  # Change to your desired log directory
if not os.path.exists(log_dir):
    os.makedirs(log_dir)
log_filename = datetime.now().strftime('%Y-%m-%d_%H-%M-%S') + 'task2_with_dropout_only.log'
