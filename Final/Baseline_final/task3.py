...
path = os.path.join('/home/thao.nguyen/CV703/Assignment_01/New/Baseline/', f"ConvNextV2L_t3_256.pth") #CHANGE
...
if not os.path.exists(log_dir):
    os.makedirs(log_dir)
log_filename = datetime.now().strftime('%Y-%m-%d_%H-%M-%S') + '_256_task3.log'
